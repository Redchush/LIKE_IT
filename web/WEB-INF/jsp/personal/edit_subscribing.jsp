...
<c:choose>
  <c:when test="${pageContext.request.method eq 'POST' and empty requestScope.isSend}">
    ...
    <jsp:useBean id="entity_bean_loaded" class="by.epam.like_it.model.bean.User" scope="request">
      ...
      <jsp:setProperty name="entity_bean_loaded" property="languageId" value="${param.first_name}"/>
  ...
  <c:otherwise>
     <jsp:forward page="/WEB-INF/jsp/part/form/form_carcass.jsp">
      <jsp:param name="to_include" value="edit_subscribing_block.jsp"/>
      <jsp:param name="to_forward" value="load_subscribing-client"/>
    </jsp:forward>
  </c:otherwise>
